...
const Generator = () => {
  const [prompt, setPrompt] = useState({job_description:"",link:"",client_name:""});
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post(`${BACKEND_URI}/generate-proposal`,prompt);
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-emerald-900 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="mb-8 text-center">
          <h1 data-aos="fade-down" className="text-5xl font-bold bg-linear-to-r from-emerald-300 via-green-300 to-teal-300 bg-clip-text text-transparent mb-2">
            Proposal Generator
          </h1>
        ...
        <div className="space-y-6">
          <form data-aos="fade-up" onSubmit={handleSubmit} className="relative group">
            ...
            <div className='flex flex-col gap-2'>
              ...
              <button
                type="submit"
                disabled={loading || !prompt.job_description.trim() || !prompt.link.trim()}
          ...
          >
            ...
            <div className="relative bg-slate-900/80 backdrop-blur border border-emerald-700/50 rounded-xl overflow-hidden hover:border-emerald-600/70 transition">
              <div className="bg-slate-950 border-b border-emerald-700/30 px-4 py-3 flex items-center justify-between">
                ...
                {!loading && response && response !== 'Generating your proposal... Please wait.' && (
                  <button
                    onClick={handleCopy}
